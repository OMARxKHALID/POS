...
<body>
  <div class="receipt-container">
    ...
    <div class="totals-section">
      <div class="total-row subtotal"><span>Subtotal:</span><span>$${actualSubtotal.toFixed(
        2
      )}</span></div>
      ${
        actualItemDiscounts > 0
          ? `<div class="total-row discount"><span>Item Discounts:</span><span>-$${actualItemDiscounts.toFixed(
              2
            )}</span></div>`
          : ""
      }
      ${
        cartDiscountAmount > 0
          ? `<div class="total-row discount"><span>Cart Discount:</span><span>-$${cartDiscountAmount.toFixed(
              2
            )}</span></div>`
          : ""
      }
      <div class="total-row tax"><span>Tax (10%):</span><span>$${taxAmount.toFixed(
        2
      )}</span></div>
      <div class="total-row final"><span>TOTAL:</span><span>$${finalTotal.toFixed(
        2
      )}</span></div>
    </div>
